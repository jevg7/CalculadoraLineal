  ...
  Compila el archivo app.py, entra al enlace y asegurate que el backend este corriendo

  Luego abre la terminal en el frontend e ingresa 'npm run dev', entra al enlace y listo
